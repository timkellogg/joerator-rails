...
describe Coffeeshop do
  ...
  it { should validate_presence_of :weekend_opens_at  }
  it { should validate_presence_of :weekend_closes_at }
  it { should validate_presence_of :weekday_opens_at  }
  it { should validate_presence_of :weekday_closes_at }
